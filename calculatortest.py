...
Button(root, text="+", command=Add).place(
    x = 10, y = 60, width = 30, height = 30)

Button(root, text="-", command=Sub).place(
    x = 10, y = 60, width = 30, height = 30)

Button(root, text="*", command=Mul).place(
    x = 10, y = 60, width = 30, height = 30)

Button(root, text="/", command=Div).place(
    x = 10, y = 60, width = 30, height = 30)

Button(root, text="%", command=Rmd).place(
    x = 10, y = 60, width = 30, height = 30)
